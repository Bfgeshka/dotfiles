...
local settings = {
  ...
  osd_dur = 3,                 --osd duration before the navigator closes, if timeout is set to true
  osd_items_per_screen = 10,   --how many menu items to show per screen
  navigator_font_size = 20,    --the font size to use for the OSD while the navigator is open
